...
CREATE TABLE `attachment` (
  ...
  `DATE_CREATED` datetime default '1971-11-26 00:00:00',
  `DATA` mediumblob,
...
CREATE TABLE `gen_order` (
  ...
  `RECEIVE_DATE` date default '1971-11-26',
  `PLANNED_DELIVERY_DATE` date default '1971-11-26',
  `CURRENCY_ID` int(11) default '1',
  `FRIENDLY_NAME` varchar(100) default '',
  `PO_DATE` date default '1971-11-26',
  `PO_NUMBER` varchar(100) default '',
  `COMMENTS` text,
  `DATE_CREATED` date NOT NULL default '1971-11-26',
...
CREATE TABLE `gen_order_history` (
  ...
  `MODIFIED_DATE` date NOT NULL default '1971-11-26',
...
INSERT INTO `groupe` (`gid`, `employer_type`, `name`) VALUES (1, 'Internal', 'Management-Internal');
INSERT INTO `groupe` (`gid`, `employer_type`, `name`) VALUES (2, 'Internal', 'Staff-Internal');
INSERT INTO `groupe` (`gid`, `employer_type`, `name`) VALUES (3, 'Buyer', 'Buyers');
INSERT INTO `groupe` (`gid`, `employer_type`, `name`) VALUES (4, 'Supplier', 'Suppliers');
INSERT INTO `groupe` (`gid`, `employer_type`, `name`) VALUES (5, 'Agent', 'Agents');
INSERT INTO `groupe` (`gid`, `employer_type`, `name`) VALUES (6, 'Internal', 'System Administrators');
INSERT INTO `groupe` (`gid`, `employer_type`, `name`) VALUES (7, 'External', 'External');
...
) ENGINE=MyISAM COMMENT='MILESTONE_TYPE' AUTO_INCREMENT=1 ;
...
INSERT INTO `party` (`PARTY_ID`, `STATE`, `CODE`, `NAME`, `TYPE`, `ADDRESS1`, `ADDRESS2`, `CITY`, `PROVINCE`, `POSTAL_CODE`, `COUNTRY_ID`, `TEL`, `MOBILE`, `FAX`, `EMAIL`, `WEBSITE`, `EMPLOYER_ID`, `POSITION`, `NOTES`, `DATE_CREATED`) VALUES (1, 'ACTIVE', NULL, 'Company Name', 'Internal', 'Address Line 1', 'Address Line 2', 'City Name', '', '', 1, '', '', '', '', '', 0, '', '', '1971-11-26 00:00:00');
...
CREATE TABLE `payment` (
  ...
  `STATE` enum('ACTIVE','INACTIVE') NOT NULL default 'ACTIVE',
  `INVOICE_ID` int(10) unsigned NOT NULL default '0',
  `DATE` date NOT NULL default '1971-11-26',
  `AMOUNT` decimal(10,2) NOT NULL default '0.00',
...
CREATE TABLE `production_step` (
  ...
  `NAME` varchar(100) NOT NULL default '',
  `DESCRIPTION` varchar(100) default '',
  `PLANNED_START_DATE` date default '1971-11-26',
  `PLANNED_START_QTY` int(11) unsigned default '0',
  `ACTUAL_START_DATE` date default '1971-11-26',
  `ACTUAL_START_QTY` int(11) unsigned default '0',
  `PLANNED_END_DATE` date default '1971-11-26',
  `PLANNED_END_QTY` int(11) unsigned default '0',
  `ACTUAL_END_DATE` date default '1971-11-26',
...
CREATE TABLE `single_order` (
  ...
  `DATE_CREATED` date default '1971-11-26',
